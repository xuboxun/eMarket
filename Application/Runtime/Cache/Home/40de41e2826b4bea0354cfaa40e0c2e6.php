	...
	<div id="main">
		...
		<div class="container classb">
			<div class="classb-content">
				<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$volistgoods): $mod = ($i % 2 );++$i;?><div class="good-area-content-col goods-block">
						<a href="/e-market/index.php/Home/Goods/detail.html?gid=<?php echo ($volistgoods["gid"]); ?>"><div class="goods-block-img"><img src="/e-market/Public/image/goods/<?php echo ($volistgoods["g_img"]); ?>"></div></a>
						<div class="goods-block-description">
							<div class="goods-price"><?php echo ($volistgoods["price"]); ?></div>
							<div class="goods-sold-num">已售<i><?php echo ($volistgoods["sold"]); ?></i>件</div>
							<div class="goods-title"><a href=""><?php echo ($volistgoods["g_name"]); ?></a></div>
