		...
		<div class="contant">
			...
			<!-- 侧边栏 -->
				...
				<div class="right"> 
				 	...
				 	<div class="liebiao">
				 				<div class="c2_goods">
								    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="c2_brand">
					 					<div class="p2_img">
					 						<a href=""><img src="/e-market/Public/image/shop/<?php echo ($vo["img"]); ?>"/></a>
					 					</div>
					 					<div class="p2_name">
